...
# ========== 数据读取 ==========
train_data = pd.read_excel("./fish_EC10_train.xlsx")
train_data = train_data.dropna().copy()

test_data = pd.read_excel("./fish_EC10_test.xlsx")
...
torch.save(model.state_dict(), "./saved_models/fish_EC10_train_test_split.pth")
print("✅ 训练完成，模型已保存到 ./saved_models/fish_EC10_train_test_split.pth")
...
os.makedirs('./fish_EC10/embeddings', exist_ok=True)
os.makedirs('./fish_EC10/bert_prediction', exist_ok=True)

np.save('./fish_EC10/embeddings/train_single.npy', X_train)
np.save('./fish_EC10/embeddings/test_single.npy', X_test)
np.save('./fish_EC10/embeddings/train_labels_single.npy', labels_train)
np.save('./fish_EC10/embeddings/test_labels_single.npy', labels_test)
...
np.save('./fish_EC10/bert_prediction/bert_single_test_predictions.npy', y_preds)
...
# 1. 目录
# =========================================================
data_dir = './fish_EC10/embeddings'
save_dir = './fish_EC10/xgb_predictions'
os.makedirs(save_dir, exist_ok=True)

# =========================================================
# 2. 最优超参数（保持不变）
# =========================================================
best_params = {'n_estimators': 800, 'learning_rate': 0.02882120731513122, 'max_depth': 6, 'subsample': 0.7906221839410269, 
               'colsample_bytree': 0.7950738465941548, 'min_child_weight': 1, 'reg_alpha': 0.0008673396070607842, 'reg_lambda': 4.8956274199403085}
