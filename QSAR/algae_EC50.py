...
# ========== 数据读取 ==========
train_data = pd.read_excel("./algae_EC50_train.xlsx")
train_data = train_data.dropna().copy()

test_data = pd.read_excel("./algae_EC50_test.xlsx")
...
# ========== 超参数 ==========
best_params = {
    'dropout_rate': 0.22560098152580843,
    'fc1_size': 832,
    'fc2_size': 224,
    'fc3_size': 192,
    'learning_rate': 3.7309451795853473e-05,
    'weight_decay': 0.03233665307923816
}
...
torch.save(model.state_dict(), "./saved_models/algae_EC50_train_test_split.pth")
print("✅ 训练完成，模型已保存到 ./saved_models/algae_EC50_train_test_split.pth")
...
os.makedirs('./algae_EC50/embeddings', exist_ok=True)
os.makedirs('./algae_EC50/bert_prediction', exist_ok=True)

np.save('./algae_EC50/embeddings/train_single.npy', X_train)
np.save('./algae_EC50/embeddings/test_single.npy', X_test)
np.save('./algae_EC50/embeddings/train_labels_single.npy', labels_train)
np.save('./algae_EC50/embeddings/test_labels_single.npy', labels_test)
...
np.save('./algae_EC50/bert_prediction/bert_single_test_predictions.npy', y_preds)
...
# 1. 目录
# =========================================================
data_dir = './algae_EC50/embeddings'
save_dir = './algae_EC50/xgb_predictions'
os.makedirs(save_dir, exist_ok=True)

# =========================================================
# 2. 最优超参数（保持不变）
# =========================================================
best_params = {'n_estimators': 300, 'learning_rate': 0.027665734151565445, 'max_depth': 6, 'subsample': 0.7536501112586395, 
               'colsample_bytree': 0.9400213505997571, 'min_child_weight': 1, 'reg_alpha': 0.001681314697256675, 'reg_lambda': 0.022102063979916476}
