...
# ========== 数据读取 ==========
train_data = pd.read_excel("./invertebrates_EC50_train.xlsx")
train_data = train_data.dropna().copy()

test_data = pd.read_excel("./invertebrates_EC50_test.xlsx")
...
# ========== 超参数 ==========
best_params = {
    'dropout_rate': 0.43746788814647014,
    'fc1_size': 832,
    'fc2_size': 224,
    'fc3_size': 256,
    'learning_rate': 4.782730367126042e-05,
    'weight_decay': 0.0006201588347304501
}
...
torch.save(model.state_dict(), "./saved_models/invertebrates_EC50_train_test_split.pth")
print("✅ 训练完成，模型已保存到 ./saved_models/invertebrates_EC50_train_test_split.pth")
...
os.makedirs('./invertebrates_EC50/embeddings', exist_ok=True)
os.makedirs('./invertebrates_EC50/bert_prediction', exist_ok=True)

np.save('./invertebrates_EC50/embeddings/train_single.npy', X_train)
np.save('./invertebrates_EC50/embeddings/test_single.npy', X_test)
np.save('./invertebrates_EC50/embeddings/train_labels_single.npy', labels_train)
np.save('./invertebrates_EC50/embeddings/test_labels_single.npy', labels_test)
...
np.save('./invertebrates_EC50/bert_prediction/bert_single_test_predictions.npy', y_preds)
...
# 1. 目录
# =========================================================
data_dir = './invertebrates_EC50/embeddings'
save_dir = './invertebrates_EC50/xgb_predictions'
